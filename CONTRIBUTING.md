...
posted to #byterub-dev on irc.freenode.net).
...
The "ByteRub Maintainer Team" is defined in this document as the following users:
- fluffypony
- byterubmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to ByteRub code or ByteRub's dependency code or ByteRub's potential/future dependency code or research which successfully implements ByteRub.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the ByteRub Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the ByteRub Maintainer Team.
