...
# Create byterub user
RUN adduser --system --group --disabled-password byterub && \
	mkdir -p /wallet /home/byterub/.bitbyterub && \
	chown -R byterub:byterub /home/byterub/.bitbyterub && \
	chown -R byterub:byterub /wallet

# Contains the blockchain
VOLUME /home/byterub/.bitbyterub
...
# switch to user byterub
USER byterub

ENTRYPOINT ["byterubd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
